...
$$
Dividiert man beider Seiten durch die Varianz $s^_{y_i}$, so normiert man den Ausdruck und kann den Faktor $1/{n-1}$ (bzw. $1/n$) herauskürzen. Es bleibt dann:
...
```
F-statistic: 203.4 on 1 and 242 DF
```
