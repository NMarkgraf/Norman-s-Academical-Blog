...
$$p = -(x_1+x_2) \quad\text{ und gleichzeitig }\quad q = x_1\cdot x_2$$
...
Nun ist $12 = 2 \cdot 2 \cdot 3$ und somit die Teilermenge von $12$ die Menge $T_{12} = \{1, 2, 4, 6, 12\}$. 
...
Für $1$ findet sich kein passender Partner in $T_{12}$, für $2$ findet sich $6$ und für $4$ findet sich $4$.

Weil $4\cdot 4 = 16 \neq 12$ fällt dieses Paar leider als Lösung aus.

Da $2 \cdot 6 = 12$ ist, haben wir mit $x_1=2$ und $x_2=6$ eine Lösung gefunden.
...
Nun ist $x_1=3{,}5-u$, $x_2=3{,}5+u$, $x_1 \cdot x_2 = 12{,}25-u^2=12$ und somit $u^2=\pm0{,}25$ und die Lösung $x_1=3$ und $x_2=4$.
